  ...
  return (
      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
          <img className="shadow-[0px_10px_200px_50px] animate-bounce shadow-center shadow-[#26cdd3] scale-90 hover:scale-100 hover:shadow-2xl transition ease-in-out duration-500 object-cover object-center rounded-lg" alt="hero" src="/images/jose.png"/>
        </div>
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <div className="flex justify-center">
            ...
            <button className="scale-90 hover:scale-100 ml-4 inline-flex text-black bg-[#26cdd3] border-0 py-2 px-6 focus:outline-none hover:bg-[#175f67] rounded  hover:text-white text-lg"><a href="/images/Jose_A_Torres_1.pdf" rel="noopener noreferrer" target="_blank">Resume</a></button>
          </div><br/>
          <div className="mt-5">
