...
export default function Hero () {
  ...
  return (
    <section className="grid grid-cols-2 gap-4 object-cover lg:h-screen md:h-screen text-gray-400 bg-gray-900 body-font">
      <div className="container bg-indigo-300 mx-auto flex px-5 py-24 md:flex-col flex-col lg:flex-col items-right">
          <div className=" lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
            <img className="shadow-[0px_10px_200px_25px] shadow-center shadow-[#268bd3] scale-90 hover:scale-100 hover:shadow-2xl transition ease-in-out duration-500 object-cover object-center rounded-lg" alt="hero" src="/images/jose.png"/>
          </div>

          <div className="lg:flex-grow md:w-1/2 lg:pl-36 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font md:text-4xl text-3xl mb-4 font-xxl text-black">Jose A. Torres
              <br/><br/>Software Engineer<br/><br/>
            </h1>
            <p className="mb-8 text-xl flex flex-col leading-relaxed text-red-500">As a creative and resourceful software engineer, I find immense joy in assisting clients and helping them achieve their objectives. My dedication to the craft is evident in the pride I take in my work. The ever-evolving landscape of software engineering excites me, and I approach the future with confidence, knowing that my contributions to the field will be meaningful and impactful.</p><br />
          </div>

          <div className="flex justify-center">
            <button  className="scale-90 hover:scale-100 inline-flex text-black bg-[#133090] border-0 py-2 px-6 focus:outline-none hover:bg-[#175f67] rounded hover:text-white btn-lg text-lg"><a href="https://bocacode.com/candidates/software-engineer/jose-torres" rel="noopener noreferrer" target="_blank">View some of my recent work.</a></button>
          <div>
          ...
          <div className=" p-8 grid lg:grid-col">  
