...
export default function Hero () {
  ...
  return (
      ...
      <div className="container bg-indigo-300 mx-auto flex px-5 py-24 md:flex-row flex-row items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <h1 className="title-font md:text-4xl text-3xl mb-4 font-xl text-black">Jose A. Torres
