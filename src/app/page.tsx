...
export default function Hero () {
  ...
  return (
      ...
      <div className="container bg-indigo-300 mx-auto flex px-5 py-24 md:flex-row flex-col items-right">
